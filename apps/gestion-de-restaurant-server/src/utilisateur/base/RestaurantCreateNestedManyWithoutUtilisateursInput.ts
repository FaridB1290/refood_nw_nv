...
@InputType()
class RestaurantCreateNestedManyWithoutUtilisateursInput {
...
export { RestaurantCreateNestedManyWithoutUtilisateursInput as RestaurantCreateNestedManyWithoutUtilisateursInput };
